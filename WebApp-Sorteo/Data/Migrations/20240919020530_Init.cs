        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CantidadTicketsTotales = table.Column<int>(type: "int", nullable: false),
                    CantidadTicketsVendidos = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sorteos_Premios_PremioId",
                        column: x => x.PremioId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_Sorteos_SorteoId",
                        column: x => x.SorteoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sorteos_PremioId",
                table: "Sorteos",
                column: "PremioId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_SorteoId",
                table: "Tickets",
                column: "SorteoId");
